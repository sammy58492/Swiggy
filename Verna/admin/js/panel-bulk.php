...
$dcm = "decimal_point";
pg_prepare($link,'sqldcpfetch11','SELECT * FROM w_configs WHERE name=$1');
$resultdcm1 = pg_execute($link,'sqldcpfetch11',array($dcm));
$rowdcm1 = pg_fetch_array($resultdcm1);
$_SESSION['decimal_value']=$rowdcm1['value'];
...
switch($_GET['u'])
	...
	case '0':
		...
		/*For Booking*/
		include('bookings.js');
		include('Servicefee.js');
		/* For Business */
	    include('business.js');		
	    include('invoicesettings.js');
	    include('csv.js');
		include('businesscsv.js');
		//Tab1
		...
		include('ButtonWidget.js');
		include('floatwidget.js');
		...
		include('extra_admin_function.php');
