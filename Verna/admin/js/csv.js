var CSV = {
    ...
    UploadCSV: function () {
	  ...
	  c +='<h3 class="popup-heading">CSV IMAGE UPLOAD</h3>'
	  c +='<form name="zipcode" id="csvimage" method="post" action="javascript:CSV.CsvUpload()" enctype="multipart/form-data" >'
	  c +='<div class="row">'
	  c +='<div class="col-md-12">'
	  c +='<div class="form-group">'
	  c +='<label>Logo Image Upload</label>'
