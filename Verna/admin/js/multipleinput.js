var MultipleInput = {
    ...
    Init: function (b, h, g, e) {
        ...
        i.setAttribute("style", "position:absolute;width:" + (this.Width + 2) + "px;height:auto;display:none;");
		...
		if(b == "resturants")
		txtlang =  "<?=$lang_resource['MULTITAG_LANGUAGE_RESTAURANTS']?>";
		else if(b == "cuisines")
		txtlang =  "<?=$lang_resource['MULTITAG_LANGUAGE_CUISINES']?>";
        else if(b == "days")
        txtlang =  "<?=$lang_resource['MULTITAG_LANGUAGE_DAYS']?>";  
        else if(b == "dishes")
        txtlang =  "<?=$lang_resource['MULTITAG_LANGUAGE_DISHES']?>";   
		else 
		txtlang = b;
		
		
        var f = '<input type="text" id="' + b + '" placeholder="'+ Main.TitleCase(txtlang) +'" autocomplete="off" class="input" style="float:left;margin:0;border:0px solid #ffffff;outline:0;"/>';
        c.innerHTML = f;
	...
	InitFrontCountry: function (b, h, g, e,g) {
        ...
        var f = '<textarea id="' + b + '" autocomplete="off" class="input" style="float:left;margin:0;border:0px solid #ffffff;outline:0;" onchange="'+g+'"></textarea>';
        c.innerHTML = f;
        d.parentNode.replaceChild(c, d);
        c.appendChild(i);
        d = document.getElementById(b);
	...
	//tabsetting End		   
        ...
        d.setAttribute("style", "position:absolute;width:" + (this.Width + 2) + "px;height:auto;display:none;");
        a.appendChild(d);
              ...
              //  $("#" + b + "_" + e + "close").click(function () {
				...
				//tabsetting end
					...
					if(b=="countrytag"){
						...
						FrontPage.setCityList(parseInt(e3));
					...
					if(b=="citytag"){
						...
						FrontPage.setRestaurantsList(parseInt(e3));
					...
					if(b=="restaurant"){
						...
						FrontPage.setRestaurantsvalue(parseInt(e3));
       ...
       // $(a).append('<input type="text" id="' + b + '" value="" class="input" style="float:left;margin:0;border:0px solid #ffffff;outline:0;"/>');evtstr='';
		...
		if(b=="countrytag"){
			evtstr=' onchange="FrontPage.setCityList()" ';
		}
		if(b=="citytag"){
			evtstr=' onchange="FrontPage.setRestaurantsList()" ';
		}
		if(b=="restaurant"){
			evtstr=' onchange="FrontPage.setRestaurantsvalue()" ';
		}
		if((evtstr!='') ||(b=='restaurant')){
			  $(a).append('<textarea id="' + b + '" value="" class="input" style="float:left;margin:0;border:0px solid #ffffff;outline:0;" '+evtstr+'></textarea>');
		}else{
			  $(a).append('<input type="text" id="' + b + '" value="" class="input" style="float:left;margin:0;border:0px solid #ffffff;outline:0;" '+evtstr+'/>');
		}
    ...
    CreateTag: function (c, b, d) {
        var a = '<div class="tag nonselectable default" id="' + b + "_" + d + 'tag">';
        a += '<span class="icaption">' + c.name + "</span>";
