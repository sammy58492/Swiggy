...
var DriverFront = {
    ...
    Home: function () {       
        ...
        b +='<li class="rest_name"><i class="fa icon-rest-icon icon-sidebar"></i><span class="username"><span id="username1">'+unsme +' '+laname+'</span></span><i class="fa  icon-pencil chevron-icon-sidebar" style="cursor:pointer;" onclick="DriverProfile.EditProfile()"></i></li>'
        ...
        b +='<li>'
        b +='<a href="javascript:DriverProfile.EditProfile()">'
