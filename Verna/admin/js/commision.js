var Commision = {
    Main: function () {
        ...
        c +='<label><?= $lang_resource['ADMIN_PAGE_SITESECTION_SITE_COMMISSION'] ?></label>'
        c +=Forms.CreateInputPropertySettings("settings", "commision",SiteSection.Settings.commision['value'], true, "SiteSection.ValueChangedWithType(this)", false, false)
