		...
		<body>
			<table width="130" border="0"  cellpadding="0" cellspacing="0">
			  ...
			  <tr><td width="50%">';
					...
					{
                      $msgRest .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/normal.jpg" border="0" width="400" height="50"  />';
					}
					else
					{
						 $msgRest .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/'.$_SESSION['scriptid'].'/normal.jpg" border="0" width="400" height="50"  />';
					}
                   $msgRest .=  '</td>';
			   ...
			   if($fblink){
				 ...
				 $msgRest .='<td><a href="https://www.facebook.com/'.$fblink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Facebook.png"  border="0" /></a></td>';
				 
		  }
			 if($twlink){	
				
				$msgRest .='<td><a href="http://www.twitter.com/'.$twlink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Twitter.png"  border="0" /></a></td>';
			 }
				
				if($rsslink){	
				
				$msgRest .='<td><a href="'.$rsslink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Feed.png"  border="0" /></a></td>';
				
				}
				if($gpluslink){	
				
				$msgRest .='<td><a href="'.$gpluslink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Google+.png"  border="0" /></a></td>';
				
				}
				if($linkendinlink){	
				
				$msgRest .='<td><a href="'.$linkendinlink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/LinkedIn.png"  border="0" /></a></td>';
				
				}
				
				if($instagramlink){	
				
				$msgRest .='<td><a href="'.$instagramlink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/instagram.png"  border="0" /></a></td>';
		 ...
		 $checkoutfields = $data->buyer->checkoutfields;
			 ...
			 if(in_array('Full Address', $checkoutfields)){
			  ...
			  if($data->buyer->reference && in_array('Where did you find about us', $checkoutfields)) {
				$msgRest .= ' <tr><td style="border-left:1px solid #e2dbdb; border-bottom:1px solid #e2dbdb;">'. $lang_resource['DELIVERY_REFERENCE_V2'] . '</td>
