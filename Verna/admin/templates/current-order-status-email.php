...
$msg ='<html><head>
		...
		<body>
			<table width="130" border="0"  cellpadding="0" cellspacing="0">
			   ...
			   <tr><td width="50%">';
					...
					{
                      $msg .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/normal.jpg?c='.time().'" border="0" width="400" height="50" />';
					}
					else
					{
						 $msg .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/'.$_SESSION['scriptid'].'/normal.jpg" border="0" width="400" height="50" />';
						//$msg .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/normal.jpg" border="0" width="400" height="50" />';
					}
                   $msg .=  '</td>';
			   ...
			   if($fblink){
				 ...
				 $msg .='<td><a href="https://www.facebook.com/'.$fblink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Facebook.png"  border="0" /></a></td>';
				 
		  }
			 if($twlink){	
				
				$msg .='<td><a href="http://www.twitter.com/'.$twlink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Twitter.png"  border="0" /></a></td>';
			 }
				
				if($rsslink){	
				
				$msg .='<td><a href="http://www.rss.com/'.$rsslink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Feed.png"  border="0" /></a></td>';
				
				}
				if($gpluslink){	
				
				$msg .='<td><a href="'.$gpluslink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Google+.png"  border="0" /></a></td>';
				
				}
				if($linkendinlink){	
				
				$msg .='<td><a href="'.$linkendinlink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/LinkedIn.png"  border="0" /></a></td>';
	...
	<table width="570" border="0" cellspacing="0" cellpadding="0"  bgcolor="#DDDDDD"><tr><td>
	<table width="560" border="0" cellspacing="0" cellpadding="0"  bgcolor="#F7F7F7">
		    <tr>
          <td height="15"></td>
        </tr>
        <tr>
		...
		if($order->driver_comment)
		{
		 $msg .='<tr>
          <td align="center" style="padding:8px 50px;">
          <span style="font-family:Arial,Georgia,sans-serif;font-size:18px;color:#df2226;line-height:22px;">
          '.$lang_resource['BUSINESS_EMAIL_DRIVERS_COMMENTS'].' :'.$order->driver_comment.'</span>    
          </td>
        </tr>';
		}
		...
		if($order->comment)
		{
		 $msg .='<tr>
          <td align="center" style="padding:8px 50px;">
          <span style="font-family:Arial,Georgia,sans-serif;font-size:18px;color:#df2226;line-height:22px;">
          '.$lang_resource['ORDER_DETAILS_DISHES_COMMENTS'].' :'.$order->comment.'</span>    
          </td>
        </tr>';
		}
    ...
    <tr>
		...
		<table width="570" border="0" cellspacing="0" cellpadding="0"  bgcolor="#DDDDDD"><tr><td>
		<table height="50" width="570" border="0"  cellpadding="0" cellspacing="0" bgcolor="#E4E9EA">
		<tr>
		<td width="110">
		...
		<table width="130" border="0" align="left" cellpadding="5" cellspacing="0">
		  ...
		  if($fblink){
			 ...
			 if($twlink){	
				...
				$msg .='<td><a href="'.$rsslink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Feed.png"  border="0" /></a></td>';
	   ...
	   <table width="570" border="0" cellspacing="0" cellpadding="0"  bgcolor="#DDDDDD"><tr><td>
	   <table width="560" height="100" border="0" cellspacing="0" cellpadding="1" bgcolor="#ffffff" style="border-bottom:5px solid #DDDDDD">
		  <tr>        
			 <td width="381">
				<table width="285" border="0"  cellpadding="1" cellspacing="0" style="padding-left: 14px;">
				   <tr>
			...
			<table width="560" height="100" border="0" cellspacing="0" cellpadding="1"  bgcolor="#ffffff">
