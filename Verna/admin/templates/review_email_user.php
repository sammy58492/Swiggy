			...
			<body>
				<table width="568" border="0" align="center" cellpadding="0" cellspacing="0">
				   ...
				   <td width="50%">';
					...
					{
                      $msg .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/normal.jpg?c='.time().'" border="0" width="300" height="50"  />';
					}
					else
					{
						 $msg .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/'.$_SESSION['scriptid'].'/normal.jpg" border="0" width="300" height="50"  />';
					}
                   $msg .=  '</td>
