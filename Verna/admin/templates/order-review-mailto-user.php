 ...
 $msg_rev ='<html>
			...
			<table width="568" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<td width="50%">';
					...
					{
                      $msg_rev .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/normal.jpg?c='.time().'" border="0" width="400" height="50"  />';
					}
					else
					{
						 $msg_rev .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/'.$_SESSION['scriptid'].'/normal.jpg" border="0" width="400" height="50"  />';
					}
                   $msg_rev .=  '</td>';
			   ...
			   if($fblink){
				 ...
				 $msg_rev .='<td><a href="https://www.facebook.com/'.$fblink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Facebook.png"  border="0" /></a></td>';
				 
		  }
			 if($twlink){	
				
				$msg_rev .='<td><a href="http://www.twitter.com/'.$twlink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Twitter.png"  border="0" /></a></td>';
			 }
				
				if($rsslink){	
				
				$msg_rev .='<td><a href="'.$rsslink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Feed.png"  border="0" /></a></td>';
				
				}
				if($gpluslink){	
				
				$msg_rev .='<td><a href="'.$gpluslink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Google+.png"  border="0" /></a></td>';
				
				}
				if($linkendinlink){	
				
				$msg_rev .='<td><a href="'.$linkendinlink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/LinkedIn.png"  border="0" /></a></td>';
				
				}
				if($instagramlink){	
				
				$msg_rev .='<td><a href="'.$instagramlink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/instagram.png"  border="0" /></a></td>';
				...
				<table width="560" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#F7F7F7">
					...
					<tr>
					  ...
					  <a style="background: #df2226; text-decoration: none;  padding: 10px 20px;   font-size: 18px;   color: #fff;" href="http://'.$_SERVER["HTTP_HOST"].'/'.$buname.'?order='.$order->id.'">'.$lang_resource['EMAIL_TEMPLATE_REVIEW_NOW'].'</a>    </td>
					</td></tr>
					<tr>
					  <td height="15"></td>
					</tr>
			  ...
			  <tr>
			   ...
			   <table width="560" height="100" border="0" cellspacing="0" cellpadding="1" align="center" bgcolor="#ffffff" style="border-bottom:5px solid #DDDDDD">
				  <tr>        
					 ...
					 <td style="padding-right:16px;"><img src="http://'.$_SERVER["HTTP_HOST"].'/panel/images/logo/3/normal.jpg?c='.time().'" width="251" height="42" border="0" /></td>
				 </tr>
			   </table>
			   </td></tr></table>
