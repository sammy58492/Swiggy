...
session_start();
 ...
 $msgBus ='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
		...
		<body>
			<table width="130" border="0"  cellpadding="0" cellspacing="0">
			  ...
			  <tr><td width="50%">';
					...
					{
                      $msgBus .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/normal.jpg" border="0" width="400" height="50"  />';
					}
					else
					{
						 $msgBus .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/'.$_SESSION['scriptid'].'/normal.jpg" border="0" width="400" height="50"  />';
					}
                   $msgBus .=  '</td>';
			   ...
			   if($fblink){
				 ...
				 $msgBus .='<td><a href="https://www.facebook.com/'.$fblink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Facebook.png"  border="0" /></a></td>';
				 
		  }
			 if($twlink){	
				
				$msgBus .='<td><a href="http://www.twitter.com/'.$twlink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Twitter.png"  border="0" /></a></td>';
			 }
				
				if($rsslink){	
				
				$msgBus .='<td><a href="'.$rsslink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Feed.png"  border="0" /></a></td>';
				
				}
				if($gpluslink){	
				
				$msgBus .='<td><a href="'.$gpluslink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/Google+.png"  border="0" /></a></td>';
				
				}
				if($linkendinlink){	
				
				$msgBus .='<td><a href="'.$linkendinlink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/LinkedIn.png"  border="0" /></a></td>';
				
				}
				if($instagramlink){	
				
				$msgBus .='<td><a href="'.$instagramlink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/instagram.png"  border="0" /></a></td>';
			   ...
			   <td><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/top_m.png" width="570px" style="display:block;" align="center" border="0" /></td>
				...
				$msgBus .='<table width="570" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#DDDDDD">
		  <tr><td>
			 ...
			 $msgBus .='<tr>
			  ...
			  if(in_array('Full Address', $checkoutfields)){
			   ...
			   if($data->buyer->reference && in_array('Where did you find about us', $checkoutfields)) {
				$msgBus .= ' <tr><td style="border-left:1px solid #e2dbdb; border-bottom:1px solid #e2dbdb;">'. $lang_resource['DELIVERY_REFERENCE_V2'] . '</td>
