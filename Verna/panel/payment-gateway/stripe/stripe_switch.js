var payu = {
    ...
    createButton: function (opts)
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/payu/payu.png" border="0" name="submit" alt="payu" class="order_btn">';
	 ...
	 createButtonReserve: function (opts)
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/payu/payu.png" border="0" name="submit" alt="payu" class="order_btn" style="width: 200px;margin-left: 10px;  height: 20px;">';
			}
