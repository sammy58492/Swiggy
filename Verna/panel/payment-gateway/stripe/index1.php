...
<script type="text/javascript">
            ...
            Stripe.setPublishableKey('pk_test_CvzFITrCOm6vRsGUiXdpJbS7');
...
if ($_POST) {
  Stripe::setApiKey("sk_test_WXW2vjTdG22uSQe8YDUvq9PQ");
  $error = '';
  $success = '';
...
?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="hidden" name="street" placeholder="Street" class="address form-control" value="<?php echo $data->buyer->address; ?>" >
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="hidden" name="city" placeholder="City" class="city form-control" value="<?php echo $data->buyer->cityname; ?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="hidden" name="state" maxlength="65" placeholder="State" class="state form-control" value="<?php echo $data->buyer->cityname; ?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="hidden" name="zip" maxlength="9" placeholder="Postal Code" class="zip form-control" value="<?php echo $data->buyer->zipcode; ?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6"> 
      <input type="hidden" name="country" placeholder="Country" class="country form-control" value="<?php echo $data->buyer->countryname; ?>" >
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="hidden" name="email" maxlength="65" placeholder="Email" class="email form-control" value="<?php echo $data->buyer->email; ?>">
    </div>
  </div>
  </fieldset>
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="hidden" name="cardholdername" maxlength="70" placeholder="Card Holder Name" class="card-holder-name form-control" value="<?php echo $data->buyer->name; ?>">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="hidden" id="cardnumber" maxlength="19" placeholder="Card Number" class="card-number form-control" value="<?php echo $data->buyer->stripecardno; ?>">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        ...
        <input type="hidden" id="select2" maxlength="2" data-stripe="exp-month" class="card-expiry-month stripe-sensitive required form-control" value="<?php echo $data->buyer->stripeexpmm; ?>">
          <select name="select2" data-stripe="exp-month" class="card-expiry-month stripe-sensitive required form-control">
            <option value="<?php echo $data->buyer->stripeexpmm; ?>" selected="selected"><?php echo $data->buyer->stripeexpmm; ?></option>
          </select>
          <span> / </span>
          <select name="select2" data-stripe="exp-year" class="card-expiry-year stripe-sensitive required form-control">
           <option value="<?php echo $data->buyer->stripeexpyy; ?>" selected="selected"><?php echo $data->buyer->stripeexpyy; ?></option>
          </select>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3">
        <input type="hidden" value="<?php echo $data->buyer->stripecvv; ?>" id="cvv" placeholder="CVV" maxlength="4" class="card-cvc form-control">
      </div>
    </div>
