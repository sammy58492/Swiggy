var paypal = {
    ...
    createButton: function (opts)
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/paypal/paypal.png" border="0" name="submit" alt="<?=$lang_resource['PAYMENT_GATEWAY_ALL_PAYPAL'];?>" class="order_btn">';
		}
	  ...
	  createButtonReserve: function (opts)
    {
		...
		if(viewDevice == "Desktop") {
        btn += '<input type="image" src="panel/payment-gateway/paypal/paypal.png" border="0" name="submit" alt="<?=$lang_resource['PAYMENT_GATEWAY_ALL_PAYPAL'];?>" class="order_btn resv-pay-btn">';
		}
		else if(viewDevice == "Mobile") {
