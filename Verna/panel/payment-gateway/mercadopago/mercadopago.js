var mercadopago  = {
    ...
    createButton: function ()
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/mercadopago/mercadopago_group.png" border="0" name="submit" alt="<?=$lang_resource['PAYMENT_GATEWAY_ALL_MERCADOPAGO'];?>" class="order_btn" style="padding:2px; margin-left:10px;">';
		}
	 ...
	 createButtonReserve: function (opts)
    {
		...
		if(viewDevice == "Desktop") {
        btn += '<input type="image" src="panel/payment-gateway/mercadopago/mercadopago_group.png" border="0" name="submit" alt="<?=$lang_resource['PAYMENT_GATEWAY_ALL_MERCADOPAGO'];?>" class="red_btn_small">';
		}
		else if(viewDevice == "Mobile") {
