...
$id = $_REQUEST['id'];
$paymentid = $_REQUEST['result'].""."(".$lang_resource['ORDER_EMAIL_TEMPLATE_TRANSATION_SUCCESSFULL'].")";
$r=$_REQUEST['result'];
$u="Success";
...
pg_prepare($link,'sql','UPDATE w_orders SET px_result=$1,px_userid=$2 WHERE id=$3');
pg_execute($link,'sql',array($r,$u,$id));
...
#####Use Mail#########
echo $msg; 
SendMail($msg,$msg_pdf,$lang_resource['PAYMENT_GATEWAY_ALL_PXPAY_SAVE_SUCCESS'],$emails,$id,$link);
//SendMail($msg,$lang_resource['PAYMENT_GATEWAY_ALL_PXPAY_SAVE_SUCCESS'],$emails);
?>