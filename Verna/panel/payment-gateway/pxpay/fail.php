...
$id = $_REQUEST['id'];
$paymentid = $_REQUEST['result'].""."(".$lang_resource['ORDER_EMAIL_TEMPLATE_TRANSATION_FAILED'].")";
$r=$_REQUEST['result'];
$u="Failed";
...
#####Use Mail#########
echo $Showmsg; 
SendMail($msg,$msg_pdf,$lang_resource['PAYMENT_GATEWAY_ALL_PXPAY_SAVE_FAILED'],$emails,$id);
//SendMail($msg,$lang_resource['PAYMENT_GATEWAY_ALL_PXPAY_SAVE_FAILED'],$emails);
?>