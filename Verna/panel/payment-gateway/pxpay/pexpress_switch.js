var pexpress = {
    ...
    createButton: function (opts)
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/pxpay/payment-express.png" border="0" name="submit" alt="pexpress" class="order_btn">';
		}
	 ...
	 createButtonReserve: function (opts)
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/pxpay/payment-express.png" border="0" name="submit" alt="pexpress" class="order_btn" style="width: 200px;margin-left: 300px;  height: 20px;">';
		}
