...
var paypaladaptive = {
    ...
    createButton: function (opts)
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/paypaladaptive/paypaladaptive.png" border="0" name="submit" alt="<?=$lang_resource['PAYMENT_GATEWAY_ALL_PayPalAdaptive'];?>" class="order_btn">';
			}
	 ...
	 createButtonReserve: function (opts)
    {
        ...
        var btn = '<form action="../payment-gateway/paypaladaptive/samples/SimpleSamples/ParallelPay.php" method="post" name="' + opts.formName + '" target="paypal-popup" onsubmit="paypaladaptive.tryToPay(\'' + opts.formName + '\',\'' + opts.itemId + '\');return false;">';
        ...
        btn += '<input type="image" src="panel/payment-gateway/paypaladaptive/paypaladaptive.png" border="0" name="submit" alt="<?=$lang_resource['PAYMENT_GATEWAY_ALL_PayPalAdaptive'];?>" class="order_btn resv-pay-btn" style="padding:2px; margin-left:305px;">';
			}        btn += '</form>';
        //iBtn.append(btn);
