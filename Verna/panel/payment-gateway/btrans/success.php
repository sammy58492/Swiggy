...
pg_prepare($link,'sqlpayu','UPDATE w_orders SET btrans_result=$1 WHERE id=$2');
...
SendMail($msg,$msg_pdf,$lang_resource['PAYMENT_GATEWAY_ALL_BTRANS_PAYMENT_SUCCESS'],$emails,$id,$link);
