...
pg_prepare($link,'sqlpayeezy','UPDATE w_orders SET payeezy_result=$1 WHERE id=$2');
pg_execute($link,'sqlpayeezy',array(123,$_REQUEST['id']));
...
#####Use Mail#########
echo $Showmsg; 
SendMail($msg,$msg_pdf,$lang_resource['PAYMENT_GATEWAY_PAYEEZY_SUCCESS'],$emails,$id,$link);
//SendMail($msg,$lang_resource['PAYMENT_GATEWAY_PAYEEZY_SUCCESS'],$emails);
?>