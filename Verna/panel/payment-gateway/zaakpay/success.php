...
<?php
	...
	$secret = '26735fa3b6514ec4aad788859c975125';
...
//$_REQUEST["AuthorizationCode"] ='XDFFD677656A';
   if($response=$_REQUEST["responseCode"] !="100")
  {
...
pg_prepare($link,'sqlpayu','UPDATE w_orders SET zaakpay_result=$1 WHERE id=$2');
pg_execute($link,'sqlpayu',array($_REQUEST["checksum"],$_REQUEST['id']));
...
SendMail($msg,$msg_pdf,$lang_resource['PAYMENT_GATEWAY_ALL_ZAAKPAY_PAYMENT_SUCCESS'],$emails,$id,$link);
