...
pg_prepare($link,'sqlpaysistix','UPDATE w_orders SET paygistix_result=$1 WHERE id=$2');
pg_execute($link,'sqlpaysistix',array($paymentid,$_REQUEST['id']));
...
SendMail($msg,$msg_pdf,$lang_resource['PAYMENT_GATEWAY_ALL_PAYGISTIX_PAYMENT_SUCCESS'],$emails,$id,$link);
