...
pg_prepare($link,'sqlpayu','UPDATE w_orders SET quickpay_result=$1 WHERE id=$2');
pg_execute($link,'sqlpayu',array($_REQUEST["AuthorizationCode"],$_REQUEST['id']));
...
SendMail($msg,$msg_pdf,$lang_resource['PAYMENT_GATEWAY_ALL_QUICK_PAYMENT_SUCCESS'],$emails,$id,$link);
