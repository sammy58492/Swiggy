var skrill = {
    ...
    createButton: function (opts)
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/skrill/skrill-button-icon.png" border="0" name="submit" alt="skrill" class="order_btn" style="width: 200px;margin-left: 20px;  height: 20px;">';
	 ...
	 createButtonReserve: function (opts)
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/skrill/skrill-button-icon.png" border="0" name="submit" alt="skrill" class="red_btn_small">';
			}
