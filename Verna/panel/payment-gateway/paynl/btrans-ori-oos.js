var btrans = {
    ...
    createButton: function (opts)
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/btrans/btrans.png" border="0" name="submit" alt="btrans" class="order_btn" style="width: 200px;margin-left: 20px;  height: 20px;">';
	 ...
	 createButtonReserve: function (opts)
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/btrans/btrans.png" border="0" name="submit" alt="btrans" class="order_btn" style="width: 200px;margin-left: 10px;  height: 20px;">';
			}
