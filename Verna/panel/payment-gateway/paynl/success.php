...
pg_prepare($link,'sqlpayu','UPDATE w_orders SET paynl_result=$1 WHERE id=$2');
pg_execute($link,'sqlpayu',array($_REQUEST["orderId"],$_REQUEST['id']));
...
SendMail($msg,$msg_pdf,$lang_resource['PAYMENT_GATEWAY_ALL_PAYNL_PAYMENT_SUCCESS'],$emails,$id,$link);
