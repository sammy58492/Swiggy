...
var maksekeskus = {
    ...
    createButton: function (opts)
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/maksekeskus/maksekeskus-pay.png" border="0" name="submit" alt="maksekeskus" class="order_btn">';
	 ...
	 createButtonReserve: function (opts)
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/maksekeskus/maksekeskus-pay.png" border="0" name="submit" alt="maksekeskus" class="order_btn" style="width: 200px;margin-left: 10px;  height: 20px;">';
			}
