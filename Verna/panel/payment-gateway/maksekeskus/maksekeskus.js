...
var maksekeskus = {
	...
	superadminButton: function (opts)
    {
		...
		var opts = $.extend(
		{
			email: 'aaba@gmail.com',
			formName: 'form26',
			itemName: 'Takeoutfactory.com Orderz',			
			itemId: maksekeskus.createId(),
			//shippingPrice: '0.09',
			iTitle: 'Additional commentsd:'
		},opts);
		
        var sbtn = '<form action="" method="post" name="' + opts.formName + '" target="paypal-popup" onsubmit="maksekeskus.SuperadmintryToPay(\'' + opts.formName + '\',\'' + opts.itemId + '\');return false;">';

        sbtn += '<input type="image" src="../panel/payment-gateway/maksekeskus/maksekeskus-pay.png" border="0" name="submit" alt="skrill" class="order_btn" style="width:160px;  height: 20px;">';
    ...
    createButton: function (opts)
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/maksekeskus/maksekeskus-pay.png" border="0" name="submit" alt="maksekeskus" class="order_btn" style="width: 200px;margin-left: 20px;  height: 20px;">';
	 ...
	 createButtonReserve: function (opts)
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/maksekeskus/maksekeskus-pay.png" border="0" name="submit" alt="maksekeskus" class="red_btn_small">';
			}
		
		btn += '</form>';        
		
        maksekeskus.forceCheckTimerStop = null;
    ...
    {
        maksekeskus.forceCheckTimerStop = true;
    },
