...
#####Use Mail#########
echo $msg;
SendMail($msg,$msg_pdf,$lang_resource['PAYMENT_GATEWAY_ALL_CARD_SAVE_SUCCESS'],$emails,$id,$link);
//SendMail($msg,$lang_resource['PAYMENT_GATEWAY_ALL_CARD_SAVE_SUCCESS'],$emails);
?>
<style>
.button {
    font-family: Arial;
...
<div style="width:100%; text-align:center;"><a href="<?php echo $WebAddress ?>" class="button"><?=$lang_resource['PAYMENT_GATEWAY_ALL_BACK'];?></a></div>
<br/>
