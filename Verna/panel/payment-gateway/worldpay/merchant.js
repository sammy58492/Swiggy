var merchant  = {
    ...
    createButton: function ()
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/worldpay/card-save_button.png" border="0" name="submit" alt="<?=$lang_resource['PAYMENT_CARDSAVE_ON_DELIVERY'];?>" class="order_btn" style="padding:2px; margin-left:10px;">';
 ...
 createButtonReserve: function ()
    {
        ...
        btn += '<input type="hidden" name="bn" value="PP-BuyNowBF:btn_buynowCC_LG.gif:NonHosted">';
		if(viewDevice == "Desktop") {
        btn += '<input type="image" src="panel/payment-gateway/worldpay/card-save_button.png" border="0" name="submit" alt="<?=$lang_resource['PAYMENT_CARDSAVE_ON_DELIVERY'];?>" class="red_btn_small" >';
		}else if(viewDevice == "Mobile") {
        btn += '<input type="image" src="panel/payment-gateway/worldpay/card-save_button.png" border="0" name="submit" alt="<?=$lang_resource['PAYMENT_CARDSAVE_ON_DELIVERY'];?>" class="btn-red" style="width:100% !important;">';
		}        btn += '</form>';
	...
	tryToPayReserve: function (formName, id)
    {
		...
		if(document.getElementById("zip1").value==""){
			swal("Error","<?= $lang_resource['PAYMENT_GATEWAY_ALL_ENTER_ZIP_CODE'] ?>","error");
