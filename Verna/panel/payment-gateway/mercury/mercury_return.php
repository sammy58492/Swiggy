...
#####Use Mail#########
echo $msg; 
SendMail($msg,$msg_pdf,$lang_resource['PAYMENT_GATEWAY_ALL_MERCURY_SUCCESS'],$emails,$id,$link);
//SendMail($msg,$lang_resource['PAYMENT_GATEWAY_ALL_MERCURY_SUCCESS'],$emails);
?>
<style>
.button {
    font-family: Arial;
