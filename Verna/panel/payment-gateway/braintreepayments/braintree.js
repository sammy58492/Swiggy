var braintree  = {
    ...
    createButton: function (){
        ...
        btn += '<input type="image" src="panel/payment-gateway/braintreepayments/braintreebutton.png" border="0" name="submit" alt="braintree" class="order_btn" style="padding:2px; margin-left:10px;">';
	...
	createButtonReserve: function (opts){
		...
		if(viewDevice == "Desktop") {
          btn += '<input type="image" src="panel/payment-gateway/braintreepayments/braintreebutton.png" border="0" name="submit" alt="<?=$lang_resource['PAYMENT_GATEWAY_ALL_BRAINTREE'];?>" class="red_btn_small" border="0">';
