var authorizednet = {
    ...
    createButton: function (opts)
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/authorizenet/Authorize_net_1.png" border="0" name="submit" alt="authorizednet" class="order_btn" >';
	 ...
	 createButtonReserve: function (opts)
    {
		...
		if(viewDevice == "Desktop") {
        btn += '<input type="image" src="panel/payment-gateway/authorizenet/Authorize_net_1.png" border="0" name="submit" alt="authorizednet" class="order_btn resv-pay-btn" style="padding:2px; margin-left:305px;">';
		}else if(viewDevice == "Mobile") {
        btn += '<input type="image" src="panel/payment-gateway/authorizenet/Authorize_net_1.png" border="0" name="submit" alt="authorizednet" class="btn-red" style="width:100% !important;">';
		}        btn += '</form>';
        //iBtn.append(btn);
