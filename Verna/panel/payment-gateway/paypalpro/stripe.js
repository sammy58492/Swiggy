var stripe = {
    ...
    createButton: function (opts)
    {
        ...
        btn += '<input type="image"  src="panel/payment-gateway/stripe/stripe.png" border="0" name="submit" alt="payu" class="btn-red" style="width:100%;">';

		}else{
        btn += '<input type="image" src="panel/payment-gateway/stripe/stripe.png" border="0" name="submit" alt="payu" class="order_btn" style="width: 200px;margin-left: 20px;  height: 20px;">';
	 ...
	 createButtonReserve: function (opts)
    {
        ...
        btn += '<input type="image" src="panel/payment-gateway/stripe/stripe.png" border="0" name="submit" alt="stripe" class="order_btn" style="width: 200px;margin-left: 10px;  height: 20px;">';
			}
