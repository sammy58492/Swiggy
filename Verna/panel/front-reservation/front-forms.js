...
var Forms = {
    ...
    CreateTextAreaPropertyNewDeliverypop: function (e, h, c, f, g, b, a, n) {
        ...
        {
            at = 'onblur="AutoPop.Locatea()"';
        }
        return '<input type="text" class="form-control"  onFocus="AutoPop.Locatea()" onkeydown="AutoPop.Locate1()" id="' + h + '"   onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ",this);" + Main.NullToEmpty(g) + '" value="'+d.value+'">';
    },
    ...
    CreateTextAreaProperty2: function (e, h, c, f, g, b, a) {
	 ...
	 CreateinputTextAddressPopup: function (e, h, c, f, g, b, a) {
        ...
        d.alwayssave = b;
        this.Form[e].fields[h] = d;
		return '<input type="text" class="' + a + ' form-control" autocomplete="off" onfocus="AutoPop.Locateb()" onkeydown="AutoPop.Locate1()" placeholder="<?= $lang_resource['ADDRESS_V2'] ?>" id="' + h + '"  onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ",this);" + Main.NullToEmpty(g) + '" value="'+d.value+'">';
    ...
    CreateTextAreaPropertyNew331: function (e, h, c, f, g, b, a, n) {
        if (this.Form[e].fields == null) {
            this.Form[e].fields = new Object()
        }
        var d = new Object();
        ...
        return '<input type="text" class="form-control" style="'+n+'" placeholder="<?= $lang_resource['ADDRESS_V2'] ?>" id="' + h + '" ' + at + ' onkeydown="AutoPop.Locate1()" onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ",this);Forms.CheckCustomSlug();" + Main.NullToEmpty(g) + '" value="'+d.value+'"><button type="button" class="geo_btn"  onclick="Main.GetUserLocation()">&nbsp;</button>'
    },
	CreateTextAreaPropertyNew33122: function (e, h, c, f, g, b, a, n) {
        if (this.Form[e].fields == null) {
            this.Form[e].fields = new Object()
        }
        var d = new Object();
        ...
        return '<input type="text" class="form-control" style="'+n+'" placeholder="<?= $lang_resource['ADDRESS_V2'] ?>" id="' + h + '" ' + at + ' onkeydown="AutoPop.Locate1()" onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ",this);" + Main.NullToEmpty(g) + '" value="'+d.value+'"><button type="button" class="geo_btn"  onclick="Main.GetUserLocation()">&nbsp;</button>'
    },
	CreateTextAreaPropertyNew3: function (e, h, c, f, g, b, a) {
        ...
        d.alwayssave = b;
        this.Form[e].fields[h] = d;
        return '<input type="text" class="form-control" placeholder="<?= $lang_resource['ADDRESS_V2'] ?>" id="' + h + '"  onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ",this);" + Main.NullToEmpty(g) + '" value="'+d.value+'">';
    },
    CreateInputProperty: function (e, g, h, d, j, i, c, b) {
        ...
        return d + '<input type="' + a + '" class="form-control" id="' + g + '" autocomplete="off" value="' + f.value + '" onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ",this);" + Main.NullToEmpty(j) + '" onkeypress="' + b + '"/>'
    },
        ...
        return '<input type="' + a + '" id="' + g + '" autocomplete="off" value="' + f.value + '" onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ",this);" + Main.NullToEmpty(j) + '" onkeypress="' + b + '" class="form-control" placeholder="'+ lk +'"/>'
    },
	CreateInputPropertyFetchByZip: function (e, g, h, d, j, i, c, b,k) {
        ...
        return '<input type="' + a + '" id="' + g + '" onblur="'+j+'" autocomplete="off" value="' + f.value + '" onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ',this);"  class="form-control" placeholder="'+ lk +'"/>'
    },
	 CreateInputPropertyPopUpreadonly: function (e, g, h, d, j, i, c, b,k) {
        ...
        return '<input type="' + a + '" id="' + g + '" autocomplete="off" value="' + f.value + '" onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ",this);" + Main.NullToEmpty(j) + '" onkeypress="' + b + '" class="form-control" placeholder="'+ lk +'" readonly/>'
    },
	...
	{
	var slug = document.getElementById("address").value;
	
	if (/^[a-z0-9-A-Z,. ]*$/.test(slug) == false ) {
			//cnt ++;
  			
			document.getElementById("address").value = slug.substr(0,slug.length-1);
    ...
    CreateSelectProperty: function (c, e, g, f, b, k, j) {
        ...
        var h = b + '<select id="' + e + '" onchange="Forms.CheckTextInput(' + Main.Quote(c) + ",this);" + Main.NullToEmpty(k) + '" class="form-control">';
        for (var a in g) {
            if (d.ivalue == g[a].id) {
	...
	CreateSelectPropertyPopup: function (c, e, g, f, b, k, j) {
		...
		if(e == "deliveryoption") { 
        var h = '<select id="' + e + '" onchange="Forms.CheckTextInput(' + Main.Quote(c) + ",this);" + Main.NullToEmpty(k) + '" class="form-control">';
		}
    ...
    CreateSelectProperty2: function (d, f, h, g, c, l, k, a) {
        ...
        e.value = e.ivalue;
        e.alwayssave = k;
        var j = '<select class="' + a + ' form-control" id="' + f + '" onchange="Forms.CheckTextInput(' + Main.Quote(d) + ",this);" + Main.NullToEmpty(l) + '">';
        for (var b in h) {
            if (e.ivalue == h[b].id) {
                j += '<option value="' + h[b].id + '" SELECTED>' + h[b].caption + "</option>"
            } else {
	...
	CreateSelectProperty2Popup1: function (d, f, h, g, c, l, k, a) {
        ...
        e.value = e.ivalue;
        e.alwayssave = k;
        var j = '<select class="' + a + ' form-control address1" id="' + f + '" onchange="Forms.CheckTextInput(' + Main.Quote(d) + ",this);" + Main.NullToEmpty(l) + '" >';
        for (var b in h) {
            if (e.ivalue == h[b].id) {
                j += '<option value="' + h[b].id + '" SELECTED>' + h[b].caption + "</option>"
            } else {
	...
	CreateInputProperty11: function (e, g, h, d, j, i, c, b) {
        ...
        return '<input type="' + a + '"  id="' + g + '" class="form-control" autocomplete="off" placeholder="mm-dd-yyyy" readonly="readonly" value="' + f.value + '" onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ",this);" + Main.NullToEmpty(j) + '" onkeypress="' + b + '"/>'
    },
	...
	CreateInputProperty10: function (e, g, h, d, j, i, c, b) {
        ...
        return '<input type="' + a + '"  id="' + g + '" class="form-control" autocomplete="off" placeholder="mm-dd-yyyy" readonly="readonly" value="' + f.value + '" onkeyup="Forms.CheckTextInput12(' + Main.Quote(e) + ",this);" + Main.NullToEmpty(j) + '" onkeypress="' + b + '"/>'
    },
	CreateSelectPropertyNew31: function (d, f, h, g, c, l, k, a) {
        ...
        e.value = e.ivalue;
        e.alwayssave = k;
        var j = '<select class="form-control" id="' + f + '" onchange="Forms.CheckTextInput12(' + Main.Quote(d) + ",this);" + Main.NullToEmpty(l) + '">';
        for (var b in h) {
            if (e.ivalue == h[b].id) {
                j += '<option value="' + h[b].id + '"  >' + h[b].caption + "</option>"
            } else {
...
CreateSelectPropertyNew32: function (d, f, h, g, c, l, k, a) {
    ...
    CreateSelectPropertyNew: function (d, f, h, g, c, l, k, a) {
        if (this.Form[d].fields == null) {
            this.Form[d].fields = new Object()
        }
        var e = new Object();
        ...
        e.value = e.ivalue;
        e.alwayssave = k;
        var j = '<select class="form-control" id="' + f + '" onchange="Forms.CheckTextInput(' + Main.Quote(d) + ",this);" + Main.NullToEmpty(l) + '">';
        for (var b in h) {
            if (e.ivalue == h[b].id) {
                j += '<option value="' + h[b].id + '" SELECTED  >' + h[b].caption + "</option>"
            } else {
	 ...
	 CreateSelectPropertyNew3: function (d, f, h, g, c, l, k, a, n) {
        ...
        var j = '<select class="form-control" id="' + f + '" onchange="Forms.CheckTextInput(' + Main.Quote(d) + ",this);" + Main.NullToEmpty(l) + '" style="'+n+'">';
        for (var b in h) {
	...
	CreateSelectPropertyNew34: function (d, f, h, g, c, l, k, a, n) {
        ...
        var j = '<select class="form-control address1" id="' + f + '" onchange="Forms.CheckTextInput(' + Main.Quote(d) + ",this);" + Main.NullToEmpty(l) + '" style="'+n+'">';
        for (var b in h) {
...
CreateInputPropertyChoiceset: function (e, g, h, d, j, i, c, b) {
	...
	CreateInputPropertyforautoProperty: function (e, h, c, f, g, b, a) {
        if (this.Form[e].fields == null) {
            this.Form[e].fields = new Object()
        }
        var d = new Object();
