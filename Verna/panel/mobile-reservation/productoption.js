			       ...
			       var  e ="";
                              ...
                              if(flag==1) {
								   ...
								   $.each(option_data['review']['extras_details'],function(option_index,option_value)
                                {
									...
									e += '<span class="pop-cnt"><?=$lang_resource['SITE_CURRENCY']?>'+parseFloat(option_value['price']).toFixed(Main.IS_DECIMAL_POINT)+'</span></div>';
       								 e += '</div>';
