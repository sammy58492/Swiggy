...
var Main = {
    ...
    InitInterface: function () {
        ...
        case "0":        
            ...
            Main.User.levelname = '<?=$lang_resource['CONTROL_PANEL_USER_SUPER_ADMIN']?>'
            break; 
        case "1":
            Admin.Home();
            Main.User.levelname = '<?=$lang_resource['CONTROL_PANEL_USER_ADMIN']?>'
            break;
        case "2":
            Provider.Home();
            Main.FetchSoundsTimeSet();
            Main.User.levelname = '<?=$lang_resource['CONTROL_PANEL_USER_RESTAURATEUR']?>'
            break;
        case "3":
            top.location = "../";
            break;
         case "4":
            ...
            Main.Config.Orders = new Object();
            Main.Config.Orders.List = new Object();
            Main.User.levelname = '<?=$lang_resource['CONTROL_PANEL_USER_DRIVER']?>'
            break;
       case "5":
            DriverManagerFront.Home();
            Main.User.levelname = '<?=$lang_resource['CONTROL_PANEL_USER_DRIVERMANAGER']?>'
            break;    
        }
    ...
    NewOrderPopupHtml: function(){
    	...
    	var n ='<div class="modal" id="modal-one">'
        n +='<div class="modal-dialog">'
        n +='<div class="neworder-box">'
        n +='<div class="new-order"><?=$lang_resource['SOUNDNEWORDERS_V2']?><div class="od-count"><div class="arrow-left"></div><span id="ordercount">'+Main.soundapproved.length+'</span></div></div>'
        n +='</div>'
        n +='<div class="modal-box">'
        n +='<div class="modal-header"><?=$lang_resource['SOUNDPENDINGORDERS_V2']?></div>'
        n +='<div class="modal-body">'
        n +='<p><?=$lang_resource['SOUNDSTOPSOUND_V2']?></p>'
        n +='<button type="button" class="ok-btn" onclick="Main.ApprovedOrder()"><?=$lang_resource['SOUNDOK_V2']?></button>'
        n +='</div>'
        n +='</div>'
        n +='</div>'
        n +='</div>'
