...
var Users = {
    ...
    PupulateTable: function (b, c) {
        ...
        for (var e in Main.Users) {
            ...
            if (h) {
                ...
                d += '<div class="username"><div class="cap"><span class="caption hand" onclick="Users.Edit(' + Main.Users[e].id + ')">' +  Main.NullToEmpty(Main.Users[e].name) + " " +  Main.NullToEmpty(Main.Users[e].lastname) + " " +  Main.NullToEmpty(Main.Users[e].lastname2) + "</span></div></div>";
                d += '<div class="type"><div class="cap"><span class="caption">' +  Main.NullToEmpty(Main.Users[e].levelname) + "</span></div></div>";
                d += '<div class="email"><div class="cap"><span class="caption">' + Main.NullToEmpty(Main.Users[e].email) + "</span></div></div>";
    ...
    Form: function (e) {
        ...
        j += '<div class="leftcol">';
        j += '<div class="row"><span class="caption"><?= $lang_resource['CONTROL_PANEL_USERS_CREATE_INPUT_NAME'] ?></span><div class="inputbox">' + Forms.CreateInputProperty("user", "name",  Main.NullToEmpty(e.name), true) + "</div></div>";
        j += '<div class="row"><span class="caption"><?= $lang_resource['CONTROL_PANEL_USERS_CREATE_INPUT_LAST_NAME'] ?></span><div class="inputbox">' + Forms.CreateInputProperty("user", "lastname", Main.NullToEmpty( e.lastname), true) + "</div></div>";
        j += '<div class="row"><span class="caption"><?= $lang_resource['CONTROL_PANEL_USERS_CREATE_INPUT_SECOND_LAST_NAME'] ?></span><div class="inputbox">' + Forms.CreateInputProperty("user", "lastname2",  Main.NullToEmpty(e.lastname2), false) + "</div></div>";
        j += '<div class="row"><span class="caption"><?= $lang_resource['CONTROL_PANEL_USERS_CREATE_INPUT_EMAIL'] ?></span><div class="inputbox">' + Forms.CreateInputProperty("user", "email",  Main.NullToEmpty(e.email), true) + "</div></div>";
        if (g) {
        ...
        j += '<div class="row"><span class="caption"><?= $lang_resource['CONTROL_PANEL_USERS_CREATE_INPUT_STREET'] ?></span><div class="inputbox">' + Forms.CreateInputProperty("user", "street",  Main.NullToEmpty(e.street), true, "GoogleMap.UpdateUserPosition(this)") + "</div></div>";
        j += '<div class="row"><span class="caption"><?= $lang_resource['CONTROL_PANEL_USERS_CREATE_INPUT_SUBURB'] ?></span><div class="inputbox">' + Forms.CreateInputProperty("user", "colony",  Main.NullToEmpty(e.colony), false, "GoogleMap.UpdateUserPosition(this)") + "</div></div>";
        ...
        j += '<div class="row"><span class="caption"><?= $lang_resource['CONTROL_PANEL_USERS_CREATE_INPUT_JOB'] ?></span><div class="inputbox">' + Forms.CreateInputProperty("user", "job", Main.NullToEmpty(e.job), false) + "</div></div>";
        if (e.id == Main.User.id) {
            ...
            case "0":
                d = "[" + a + '{"id":"1","caption":"<?=$lang_resource['CONTROL_PANEL_USER_ADMIN']?>"},{"id":"2","caption":"<?=$lang_resource['CONTROL_PANEL_USER_RESTAURATEUR']?>"},{"id":"3","caption":"<?=$lang_resource['CONTROL_PANEL_USER_CUSTOMER']?>"}]';
                break;
            case "1":
                d = "[" + a + '{"id":"2","caption":"<?=$lang_resource['CONTROL_PANEL_USER_RESTAURATEUR']?>"},{"id":"3","caption":"<?=$lang_resource['CONTROL_PANEL_USER_CUSTOMER']?>"}]';
                break
            }
            d = JSON.parse(d);
      ...
      //  alert(e.isimg)
        if(e.isimg==1){
            ...
            b= "background-image:url('images/dummy/dummy_user.jpg');"
            }
