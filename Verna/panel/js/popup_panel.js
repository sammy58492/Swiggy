var Popup = {
    Init: function (b) {
        ...
        a += '<div id="popupbox"><div class="innerbox">';
        a += '<div class="cancel hand" onclick="Popup.OnCancel()"></div><div id="popupmainbuttonok" class="ok disabled hand"></div>';
        a += '<div id="popup" class="content"></div></div></div></div>';
