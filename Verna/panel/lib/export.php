...
$rowtimeformat = pg_fetch_array($resulttimeformat);
    $data = parse($data);
  	$type = $data->type;
       ...
       $msg .= '<td align="center"><span style="font-size:16px;font-weight:bold;">'.$lang_resource['ORDERS_BOX_DATE_HEADER'].'</span></td>';
       $msg .= '<td align="center"><span style="font-size:16px;font-weight:bold;">'.$lang_resource['CONTROL_PANEL_FRANCHISES_CITY_HEADER'].'</span></td>';
       $msg .= '<td align="center"><span style="font-size:16px;font-weight:bold;">'.$lang_resource['FRONT_VISUALS_RESTAURANT'].'</span></td>';

       $msg .= '<td align="center"><span style="font-size:16px;font-weight:bold;">'.$lang_resource['BUSINESS_BILLING_OPTIONS'].'</span></td>';
       $msg .= '<td align="center"><span style="font-size:16px;font-weight:bold;">'.$lang_resource['INVOICE_SETUP_RATE'].'</span></td>';
	   $msg .= '<td align="center"><span style="font-size:16px;font-weight:bold;">'.$lang_resource['INVOICE_FIXED_RATE'].'</span></td>';
	   $msg .= '<td align="center"><span style="font-size:16px;font-weight:bold;">'.$lang_resource['INVOICE_EXPORT_PER_ORDER_COMMISSION'].'</span></td>';
	   $msg .= '<td align="center"><span style="font-size:16px;font-weight:bold;">'.$lang_resource['INVOICE_PER_ORDER_FIXED_RATE'].'</span></td>';
	   $msg .= '<td align="center"><span style="font-size:16px;font-weight:bold;">'.$lang_resource['INVOICE_OTHER_RATE'].'</span></td>';
	   $msg .= '<td align="center"><span style="font-size:16px;font-weight:bold;">'.$lang_resource['INVOICE_EXPORT_FROM_DATE'].'</span></td>';
	   $msg .= '<td align="center"><span style="font-size:16px;font-weight:bold;">'.$lang_resource['INVOICE_EXPORT_TO_DATE'].'</span></td>';
	   $msg .= '<td align="center"><span style="font-size:16px;font-weight:bold;">'.$lang_resource['ORDERS_BOX_STATUS_HEADER'].'</span></td>';
	   $msg .= '<td align="center"><span style="font-size:16px;font-weight:bold;">'.$lang_resource['INVOICE_TOTAL'].'</span></td>';
       $msg .= '<td align="center"><span style="font-size:16px;font-weight:bold;">'.$lang_resource['Total_Orders'].'</span></td></tr>';
	   ...
	   foreach ($data->ids as $id){
		   ...
		   switch ($row['billing'])
		   {
				...
				case '1':
					$billing = $lang_resource['INVOICE_ORDER_BILLING_TAB'];
				break;
				case '2':
					$billing = $lang_resource['INVOICE_EXPORT_Manually'];
				break;
		   }
		   $msg .= '<td>'.$billing.'</td>';
