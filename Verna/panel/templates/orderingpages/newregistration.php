...
';
					...
					{
                      $msg1 .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/normal.jpg" border="0"  width="300" height="40" />';
					}
					else
					{
						 $msg1 .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/'.$_SESSION['scriptid'].'/normal.jpg" border="0"  width="300" height="40" />';
					}
                   $msg1 .=  '</td>
		...
		<span style="font-family:Arial,Georgia,sans-serif;font-size:18px;color:#df2226;line-height:22px;">'.$lang_resource['THANK_YOU_REGISTERING'].''.$lang_resource['YOUR_NEW_PASSWORD_IS'].':</span>
		</td>
		</tr>
		<tr>
		<td align="center" style="padding:8px 50px;">
