...
session_start();
 ...
 $msg_rev ='<html>
			...
			<title>'.$lang_resource['ORDER_STATUS_MULTIPLE_CHANGE'].'</title>
			...
			<body>
				<table width="568" border="0" align="center" cellpadding="0" cellspacing="0">
				   ...
				   <td width="50%">';
					...
					{
                      $msg_rev .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/normal.jpg" border="0"  width="300" height="50"  />';
					}
					else
					{
						 $msg_rev .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/'.$_SESSION['scriptid'].'/normal.jpg" border="0"  width="300" height="50"  />';
					}
                   $msg_rev .=  '</td>
				   ...
				   if($fblink){
                        $msg_rev = '<td><a href="http://www.twitter.com/'.$twlink.'">
                           <img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/fb_m.png"  border="0" />
                        </a></td>';
						}else{
							$msg_rev = '<td><a href="http://www.twitter.com">
                           <img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/fb_m.png"  border="0" />
                        </a></td>';
							
						}
                  	   if($fblink){
                        $msg_rev = '<td><a href="http://www.facebook.com/'.$fblink.'">
                           <img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/twitter_m.png"  border="0" />
                        </a></td>';
						}else{
                    		 $msg_rev = '<td><a href="http://www.facebook.com">
                          <img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/twitter_m.png"  border="0" />
                        </a></td>';
						}
						 if($fblink){						
                           $msg_rev = '<td><a href="'.$rsslink.'">
                            <img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/rss_m.png"  border="0" />
                        </a></td>';
						
						 }else{
							 $msg_rev = '<td><a href="https://www.rss.com/">
                           <img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/rss_m.png"  border="0" />
                      	  </a></td>';	 
						 }
				...
				<table width="560" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#F7F7F7">
					...
					<tr>
					  ...
					  '.$lang_resource['EMAIL_CURRENT_ORDER_STATUS_FOR_ORDER_NO'].' '.$order->id.' '.$lang_resource['EMAIL_TEMPLATE_UPDATE_IS'].' '.$order->status.'</span>    
					  </td>
					</tr>';
			...
			<table width="130" border="0" align="left" cellpadding="5" cellspacing="0">
			  ...
			  if($fblink){
                        $msg_rev = '<td><a href="http://www.twitter.com/'.$fblink.'">
                           <img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/fb_m.png"  border="0" />
                        </a></td>';
						}else{
							$msg_rev = '<td><a href="http://www.twitter.com">
                  	   ...
                  	   if($fblink){
                        $msg_rev = '<td><a href="http://www.facebook.com/'.$twlink.'">
                           <img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/twitter_m.png"  border="0" />
                        </a></td>';
						}else{
                    		 $msg_rev = '<td><a href="http://www.facebook.com">
