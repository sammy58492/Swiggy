			...
			<body>
				<table width="568" border="0" align="center" cellpadding="0" cellspacing="0">
				   ...
				   <td width="50%">';
					...
					{
                      $msg .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/images/email_template/logo-with-black-text.png" border="0"  width="300" height="40"  />';
					}
					else
					{
			   ...
			   <td><a href="'.$instagramlink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/instagram.png"  border="0" /></a></td>
				...
				<table width="560" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#F7F7F7">
					...
					<tr>
					  ...
					  '.$lang_resource['FRONT_MAIN_EMAIL_PASSWORD_REQUESTED'].':</span>
					  </td>
					</tr>
					  <tr>
					  <td align="center" style="padding:8px 50px;">
				  ...
				  <tr>
					 <td width="381">
						<table width="285" border="0" align="center" cellpadding="1" cellspacing="0" style="padding-left: 14px;">
						   <tr>
							  <td width="110" height="20"><span style="font-family:arial,verdana,serif;font-size:11px;color:#df2226;"><strong>&nbsp;</strong></span></td>
						   </tr>
						   <tr>
							  <td height="17"><span style="font-family:arial,verdana,serif;font-size:11px;color:#df2226;"><strong>&nbsp;</strong></span></td>
						   </tr>
						   <tr>
							  <td height="17"><span style="font-family:arial,verdana,serif;font-size:11px;color:#df2226;"><strong>&nbsp;</strong></span></td>
						   </tr>
					 ...
					 <td style="padding-right:16px;"><img src="http://'.$_SERVER['HTTP_HOST'].'/images/email_template/logo-with-black-text.png" width="251" height="42" border="0" /></td>
				 </tr>
			   </table>
			   </td></tr></table>
