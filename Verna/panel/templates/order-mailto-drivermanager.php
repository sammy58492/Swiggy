		...
		<body>
			<table width="568" border="0" align="center" cellpadding="0" cellspacing="0">
			   ...
			   <td width="50%">';
					...
					{
                      $msgDriverManger .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/normal.jpg" border="0"  width="300" height="40"  />';
					}
					else
					{
						 $msgDriverManger .=   '<img src="http://'.$_SERVER['HTTP_HOST'].'/panel/images/logo/1/'.$_SESSION['scriptid'].'/normal.jpg" border="0"  width="300" height="40"  />';
					}
                   $msgDriverManger .=  '</td>
		...
		<table width="560" style="border:0px solid #e2dbdb;" align="center" cellspacing="0" cellpadding="4" bgcolor="#F7F7F7">
		  ...
		  ';
		   if($data->buyer->reference) {
			$msgDriverManger .= ' <tr><td style="border-left:1px solid #e2dbdb; border-bottom:1px solid #e2dbdb;">'. $lang_resource['Referenece_V2'] . '</td>
