<?
       ...
       while($conf = pg_fetch_array($configResult))
			   ...
			   if($order->buyer->country !="") {
				...
				if($cur_record['bringg_key_type'] == 't'){
					$test = "true";
					$bringg_token  = $cur_record['bring_access_token_live'];
					$bringg_secret  = $cur_record['bring_secret_key_live'];
					$bringg_company_id  = $cur_record['bringg_company_id_live'];
					$bringg_company_name  = $cur_record['bringg_company_name_live'];
					
					} else {
					$test = "false";
					$bringg_token  = $cur_record['bring_access_token_test'];
					$bringg_secret  = $cur_record['bring_secret_key_test'];
					$bringg_company_id  = $cur_record['bringg_company_id_test'];
					$bringg_company_name  = $cur_record['bringg_company_name_test'];
