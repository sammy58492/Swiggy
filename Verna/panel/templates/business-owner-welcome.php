			   ...
			   <td><a href="'.$rsslink.'" target="_blank"><img src="http://'.$_SERVER["HTTP_HOST"].'/images/email/rss_m.png"  border="0" /></a></td> 
				...
				<table width="560" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#F7F7F7">
					...
					<tr>
					  ...
					  '.$lang_resource['BUSINESS_OWNER_WELCOME_LINE1'].' '.$bus_name1.'</span>
					...
					<tr>
					  ...
					  '.$lang_resource['BUSINESS_OWNER_WELCOME_LINE2'].': '.$bus_email1.'</span>
					...
					<tr>
					  ...
					  '.$lang_resource['BUSINESS_OWNER_WELCOME_LINE3'].': '.$bus_pass1.'</span>
					  </td>
					</tr>
