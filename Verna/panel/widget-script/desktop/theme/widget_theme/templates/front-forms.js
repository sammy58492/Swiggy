...
var Forms = {
    ...
    CreateTextAreaProperty2: function (e, h, c, f, g, b, a) {
	 ...
	 CreateinputTextAddressPopup: function (e, h, c, f, g, b, a) {
        ...
        d.alwayssave = b;
        this.Form[e].fields[h] = d;
		return '<input type="text" class="' + a + ' field_text_pop" onfocus="AutoPop.Locatea()" onkeydown="AutoPop.Locate1()"  placeholder="<?= $lang_resource['ADDRESS_V2'] ?>" id="' + h + '"  onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ",this);" + Main.NullToEmpty(g) + '" value="'+d.value+'">';
    ...
    CreateTextAreaPropertyNew331: function (e, h, c, f, g, b, a, n) {
		...
		if(Main.WidgetSettings) {
			n +="color: "+Main.WidgetSettings.site_settings.font_color;
			}
        return '<input type="text" class="form-control hand" style=" border-radius:4px 0px 0px 4px; float:left; '+n+'" placeholder="<?= $lang_resource['ADDRESS_V2'] ?>" id="' + h + '" ' + at + '  onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ",this);" + Main.NullToEmpty(g) + '" value="'+d.value+'"><button type="button" class="geo_btn_delivery" onclick="Main.GetUserLocation()"><img src="images/homeimage/add-icon.png"></button>';
    },
	
	CreateTextAreaPropertyNew3311: function (e, h, c, f, g, b, a, n) {
        if (this.Form[e].fields == null) {
            this.Form[e].fields = new Object()
        }
        var d = new Object();
        ...
        return '<input type="text" class="form-control" style=" border-radius:4px 0px 0px 4px; float:left; '+n+'" placeholder="<?= $lang_resource['ADDRESS_V2'] ?>" id="' + h + '" ' + at + '  onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ",this);" + Main.NullToEmpty(g) + '" value="'+d.value+'"><button type="button" class="geo_btn_delivery" onclick="Main.GetUserLocation()"><img src="images/homeimage/add-icon.png"></button>';
    },
	
	CreateTextAreaPropertyNew33112: function (e, h, c, f, g, b, a, n) {
        if (this.Form[e].fields == null) {
            this.Form[e].fields = new Object()
        }
        var d = new Object();
        ...
        return '<input type="text" class="form-control" style=" border-radius:4px 0px 0px 4px; float:left; '+n+'" placeholder="<?= $lang_resource['ADDRESS_V2'] ?>" id="' + h + '" ' + at + '  onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ",this);" + Main.NullToEmpty(g) + '" value="'+d.value+'"><br /><br />';
    },
	...
	CreateTextAreaPropertyNew3: function (e, h, c, f, g, b, a) {
        ...
        d.alwayssave = b;
        this.Form[e].fields[h] = d;
        return '<input type="text" class="field_text hand" style=" border-radius:4px 0px 0px 4px; float:left;" placeholder="<?= $lang_resource['ADDRESS_V2'] ?>" id="' + h + '"  onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ",this);" + Main.NullToEmpty(g) + '" value="'+d.value+'">';
    },
	...
	CreateInputPropertyFetchByZip: function (e, g, h, d, j, i, c, b,k) {
        ...
        return '<input type="' + a + '" id="' + g + '" onblur="'+j+'" autocomplete="off" value="' + f.value + '" onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ',this);"  class="field_text_pop" placeholder="'+ lk +'"/>'
    },
	 CreateInputPropertyPopUpreadonly: function (e, g, h, d, j, i, c, b,k) {
        ...
        return '<input type="' + a + '" id="' + g + '" autocomplete="off" value="' + f.value + '" onkeyup="Forms.CheckTextInput(' + Main.Quote(e) + ",this);" + Main.NullToEmpty(j) + '" onkeypress="' + b + '" class="field_text_pop" placeholder="'+ lk +'" readonly/>'
    },
	...
	CreateSelectPropertyPopup: function (c, e, g, f, b, k, j) {
        ...
        var h = '<select id="' + e + '" onchange="Forms.CheckTextInput(' + Main.Quote(c) + ",this);" + Main.NullToEmpty(k) + '" class="field_text_pop preorder_slt">';
		} else {
	    var h = '<select id="' + e + '" onchange="Forms.CheckTextInput(' + Main.Quote(c) + ",this);" + Main.NullToEmpty(k) + '" class="field_text_pop preorder_slt">';
			}
...
CreateSelectPropertyNew32: function (d, f, h, g, c, l, k, a) {
	 ...
	 CreateSelectPropertyNew3: function (d, f, h, g, c, l, k, a, n) {
		...
		//alert(Main.WidgetSettings.site_settings.font_color)
	...
	CreateSelectPropertyNew4: function (d, f, h, g, c, l, k, a) {
        if (this.Form[d].fields == null) {
            this.Form[d].fields = new Object()
        }
        var e = new Object();
	...
	CreateSelectPropertyNew34: function (d, f, h, g, c, l, k, a, n) {
        ...
        var j = '<select class="hand form-control address1" id="' + f + '" onchange="Forms.CheckTextInput(' + Main.Quote(d) + ",this);" + Main.NullToEmpty(l) + '" style="'+n+'">';
        for (var b in h) {
	...
	CreateSelectPropertyNew347: function (d, f, h, g, c, l, k, a, n) {
        if (this.Form[d].fields == null) {
            this.Form[d].fields = new Object()
        }
        var e = new Object();
