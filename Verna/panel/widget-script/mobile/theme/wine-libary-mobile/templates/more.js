var More = {
 Start: function ()
	...
	var t ="";	
        ...
        t +='</div>';
        t +='</div>';
        t +='<div class="logo" style="margin-top:8px;"><a href="javascript:Main.HomeUrlCustom()"><img src="panel/images/logo/1/normal.jpg" width="280" height="40"></a></div>';
        t +='</div>';
    t +='</div>';
	...
	if(Main.settingfront.popular_restaurant != 'f' && Main.settingfront.list_step != 'f') { 
  	...
  	t +='<h3  style=" background:#e74c3c !important; text-align:left !important; border-radius:0px !important; padding: 0.7em 0.5em 0.7em 0.7em !important; font-size:17px !important; color:#fff; margin-top:0 !important;"><?=$lang_resource['MOBILE_MORE_MOST_POPULAR']?></h3>';
   ...
   t +='<h3 style="background:#e74c3c !important; text-align:left !important; border-radius:0px !important; padding: 0.7em 0.5em 0.7em 0.7em !important; font-size:17px !important; color:#fff; margin-top:0 !important;"><?=$lang_resource['MOBILE_MORE_MOST_POPULAR_CUISINE']?></h3>';
 	 t +='<div class="acco_dvdp">';
 	 t +='<div class="info-dv">';
     t +='<div id="demo2">';
	...
	if (Main.popularscategory) {
			for (var l in Main.popularscategory) {
				   ...
				   if(Main.popularscategory[l]["status"] == 1)
				link_url = "panel/images/category/" + Main.popularscategory[l]['id'] + "/1/panel.jpg?c='" + Main.Random ;
				else
				link_url = "panel/images/dummy/category_dummy.jpg" ;
				var catnm = Main.popularscategory[l]["name"].split(" ").join("@-@");
                  	t += '<div class="item"><a href="Cuisine_' +catnm + '"><img src="'+link_url+'" style="height:195px"></a>';
				    t += '<span style="width:100%; float:left; margin-top:10px;text-align:center"><a style="text-decoration:none;color:#333;" href="Cuisine_' + catnm + '">' + Main.popularscategory[l]["name"] +'</a></span></div>';
   ...
   /****************cuisine part*****************************/
   t +='<h3 style="background:#e74c3c !important; text-align:left !important; border-radius:0px !important; padding: 0.7em 0.5em 0.7em 0.7em !important; font-size:17px !important; color:#fff; margin-top:0 !important"><?=$lang_resource['MOBILE_MORE_HOW_IT_WORKS']?></h3>';
  ...
  t +=' <div class="acco_dvdp">';
   ...
   t +='<h3 style="background:#e74c3c !important; text-align:left !important; border-radius:0px !important; padding: 0.7em 0.5em 0.7em 0.7em !important; font-size:17px !important; color:#fff; margin-top:0 !important"><?=$lang_resource['MOBILE_MORE_RECENT_ORDERS']?></h3>';
 	   t +='<div class="acco_dvdp">';
   ...
   t +='</div>';
   t +='<h3 style="background:#e74c3c !important; text-align:left !important; border-radius:0px !important; padding: 0.7em 0.5em 0.7em 0.7em !important; font-size:17px !important; color:#fff; margin-top:0 !important"><?=$lang_resource['MOBILE_MORE_LETS_BE_FRIENDS']?></h3>';
   t +='<div class="acco_dvdp">';
	...
	/********************************** Usefull Links ************************************************/
	t +='<h3 style="background:#e74c3c !important; text-align:left !important; border-radius:0px !important; padding: 0.7em 0.5em 0.7em 0.7em !important; font-size:17px !important; color:#fff; margin-top:0 !important"><?=$lang_resource['MOBILE_MORE_USEFULLINKS']?></h3>';
